...
> Optimized for use with the [StageFreight GitLab component](https://gitlab.prplanit.com/components/stagefreight/gl-component-release), but designed to grow beyond GitLab-specific tooling.
